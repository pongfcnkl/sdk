...
# 查找录像文件并按文件名下载
def download_record_by_time(lUserID, iChannelNo):
...
def dvr_find_file(iChannelNo, lUserID):
    ...
    # 起始时间
    net_dvr_filecond.struStartTime.wYear = 2024
    net_dvr_filecond.struStartTime.byMonth = 8
    net_dvr_filecond.struStartTime.byDay = 27
    ...
    # 停止时间
    net_dvr_filecond.struStopTime.wYear = 2024
    net_dvr_filecond.struStopTime.byMonth = 8
    net_dvr_filecond.struStopTime.byDay = 27
    net_dvr_filecond.struStopTime.byHour = 0
    net_dvr_filecond.struStopTime.byMinute = 1
...
def download_record_by_time(userID):
    ...
    net_dvr_playcond.dwChannel = 34  # 通道号

    # 开始时间
    net_dvr_playcond.struStartTime.dwYear = 2024
    net_dvr_playcond.struStartTime.dwMonth = 9
    net_dvr_playcond.struStartTime.dwDay = 20
    net_dvr_playcond.struStartTime.dwHour = 0
    net_dvr_playcond.struStartTime.dwMinute = 0
    net_dvr_playcond.struStartTime.dwSecond = 0

    # 停止时间
    net_dvr_playcond.struStopTime.dwYear = 2024
    net_dvr_playcond.struStopTime.dwMonth = 9
    net_dvr_playcond.struStopTime.dwDay = 20
    net_dvr_playcond.struStopTime.dwHour = 3
